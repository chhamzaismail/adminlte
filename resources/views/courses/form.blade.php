            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form_parent">
                    <h1 class="heading primary">ADD Course</h1>
                    <form action="{{url('course/form')}}" method="post">
                    @csrf
                    
                        <label for="c_name">Course Name</label>
                        <input type="text" name="c_name" placeholder="Enter course name"  value="{{old('c_name')}}">
                        ...
                        <input type="text" name="c_code" placeholder="Enter course code"  value="{{old('c_code')}}">
                        <span class="text-danger">
                            @error('c_code')
                                {{$message}}
                            @enderror
